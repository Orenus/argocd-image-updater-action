...
class ArgoCDClient {
    constructor() {
        ...
        this.logger = SimpleLogger_1.default.instance;
    }
    /**
     ...
     */
    login(username, password, serverHost, serverPort = 443, useHttps = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.token) {
                ...
                try {
                    const res = yield this.client.post(`${this.serverURL}${this.apiPath}/session`, { username, password });
                    if (res.status !== 200) {
                        return false;
                    }
     ...
     */
    sync(context, createNamespace = false, dryRun = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const options = {
                prune: false,
                dryRun
     ...
     */
    getAppManifests(appName) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.get(`/applications/${appName}/manifests`);
     ...
     */
    getImagePatchHelmPayload(app, newImageID, helmParamKeyName) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!((_a = app.spec.source) === null || _a === void 0 ? void 0 : _a.helm)) {
                throw new Error('unable to find the helm key on the source spec data!');
            }
            const imageParamIndex = (app.spec.source.helm.parameters || []).findIndex((e) => e.name === helmParamKeyName);
     ...
     */
    updateImage(context, newImageID, helmParamKeyName = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!context.appName) {
                throw new Error('appName is mandatory for updateImage procedure');
            }
            const syncType = yield this.getSyncSourceType(context.appName);
            const fullInfo = true;
            const apps = yield this.getApps(context, fullInfo);
            if (apps.length !== 1) {
                throw new Error(`in update image, cant find app ${context.appName}`);
            }
            let patchPayload;
            if (syncType === common_1.SyncSourceTypeEnum.HELM) {
                if (!helmParamKeyName) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SyncSourceTypeEnum = void 0;
var SyncSourceTypeEnum;
(function (SyncSourceTypeEnum) {
...
const ArgoCDClient_1 = __importDefault(__nccwpck_require__(4183));
const ArgoCDContext_1 = __importDefault(__nccwpck_require__(5510));
const SimpleLogger_1 = __importStar(__nccwpck_require__(7911));
const utils_1 = __nccwpck_require__(918);
const logger = SimpleLogger_1.default.instance;
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const argocdPassword = core.getInput('argocd_password');
            ...
            const ctx = new ArgoCDContext_1.default();
            ctx.appName = appName;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.labelsStringToObject = void 0;
/**
